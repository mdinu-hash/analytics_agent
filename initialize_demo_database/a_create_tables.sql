...
DROP TABLE IF EXISTS fact_household_monthly;
DROP TABLE IF EXISTS fact_account_product_monthly;
DROP TABLE IF EXISTS fact_account_monthly;
DROP TABLE IF EXISTS fact_account_initial_assets;
DROP TABLE IF EXISTS advisor_payout_rate;
DROP TABLE IF EXISTS tier_fee;
...
CREATE TABLE advisor_payout_rate (
    ...
    advisor_payout_rate REAL NOT NULL  -- stored as decimal (e.g., 0.7800 for 78%)
);
...
CREATE TABLE fact_account_initial_assets (
    ...
    account_initial_assets REAL NOT NULL CHECK (account_initial_assets > 0)
);
...
CREATE TABLE fact_account_monthly (
    ...
    account_monthly_return REAL NOT NULL CHECK (account_monthly_return BETWEEN -0.12 AND 0.12),
...
CREATE TABLE fact_account_product_monthly (
    ...
    product_allocation_pct REAL NOT NULL CHECK (product_allocation_pct BETWEEN 0 AND 100),
...
CREATE TABLE fact_household_monthly (
    ...
    high_net_worth_flag INTEGER NOT NULL,  -- 0 = False, 1 = True
